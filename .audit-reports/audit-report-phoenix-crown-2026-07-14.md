...
| 顺序 | ID | 动作 | PR |
|---|---|---|---|
| 1 | P1-TEST | 引入 vitest + 2 纯函数测试 | PR-A |
| 2 | P1-THEME | 主题/语言 localStorage 持久化 | PR-B |
| 3 | P2-EN-NOOP | README 文档化"英文仅 UI 本地化" | PR-C |

复扫达标线：**P0=0, P1=0** 即闭环（当前已 85/A-、P0/P1 仅 2 项，修复后预期 88+/A）。
